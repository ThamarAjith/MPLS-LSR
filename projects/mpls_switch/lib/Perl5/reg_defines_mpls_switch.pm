...
#
# Project: MPLS dram switch (mpls_switch)
# Description: MPLS switch
#
#############################################################

package reg_defines_mpls_switch;
...
@EXPORT = qw(
                ...
                NUM_OUTPUT_QUEUES
                DRAM_DATA_WIDTH
                DRAM_BLOCK_RDWR_ADDR_WIDTH
                OQ_DEFAULT_MAX_PKTS
                OQ_DRAM_PKT_CNT_WIDTH
                OQ_DRAM_WORD_CNT_WIDTH
                OQ_DRAM_BYTE_CNT_WIDTH
                OQ_DISABLE_SEND_BIT_NUM
                ...
                SWITCH_OP_LUT_BASE_ADDR
                IN_ARB_BASE_ADDR
                OQ_BASE_ADDR
                BRAM_REG_ACCESS_BASE_ADDR
                DRAM_BASE_ADDR
                CPU_QUEUE_OFFSET
                MAC_GRP_OFFSET
                DEV_ID_MD5_0_REG
                ...
                SWITCH_OP_LUT_MAC0_HI_REG
                SWITCH_OP_LUT_MAC0_LO_REG
                SWITCH_OP_LUT_MAC1_HI_REG
                SWITCH_OP_LUT_MAC1_LO_REG
                SWITCH_OP_LUT_MAC2_HI_REG
                SWITCH_OP_LUT_MAC2_LO_REG
                SWITCH_OP_LUT_MAC3_HI_REG
                SWITCH_OP_LUT_MAC3_LO_REG
                SWITCH_OP_LUT_LS1_BASE_REG
                SWITCH_OP_LUT_LS1_BOUND_REG
                SWITCH_OP_LUT_LS2_BASE_REG
                SWITCH_OP_LUT_LS2_BOUND_REG
                SWITCH_OP_LUT_LS3_BASE_REG
                SWITCH_OP_LUT_LS3_BOUND_REG
                SWITCH_OP_LUT_LS4_BASE_REG
                SWITCH_OP_LUT_LS4_BOUND_REG
                SWITCH_OP_LUT_LD_BASE_REG
                SWITCH_OP_LUT_LD_BOUND_REG
                SWITCH_OP_LUT_COUNTER1_BASE_REG
                SWITCH_OP_LUT_COUNTER2_BASE_REG
                SWITCH_OP_LUT_SOFT_OFFSET_REG
                SWITCH_OP_LUT_NOT_FOR_US_REG
                SWITCH_OP_LUT_PARITY_ERROR_REG
                SWITCH_OP_LUT_TTL_ERROR_REG
                SWITCH_OP_LUT_LS_ERROR_REG
                SWITCH_OP_LUT_LD_ERROR_REG
                ...
                OQ_QUEUE_0_INPUT_WORDS_REG
                OQ_QUEUE_0_OUTPUT_WORDS_REG
                OQ_QUEUE_0_SHORTCUT_WORDS_REG
                OQ_QUEUE_0_DRAM_WR_WORDS_REG
                OQ_QUEUE_0_DRAM_RD_WORDS_REG
                OQ_QUEUE_0_CTRL_REG
                OQ_QUEUE_0_ADDR_LO_REG
                OQ_QUEUE_0_ADDR_HI_REG
                OQ_QUEUE_0_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_1_INPUT_WORDS_REG
                OQ_QUEUE_1_OUTPUT_WORDS_REG
                OQ_QUEUE_1_SHORTCUT_WORDS_REG
                OQ_QUEUE_1_DRAM_WR_WORDS_REG
                OQ_QUEUE_1_DRAM_RD_WORDS_REG
                OQ_QUEUE_1_CTRL_REG
                OQ_QUEUE_1_ADDR_LO_REG
                OQ_QUEUE_1_ADDR_HI_REG
                OQ_QUEUE_1_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_2_INPUT_WORDS_REG
                OQ_QUEUE_2_OUTPUT_WORDS_REG
                OQ_QUEUE_2_SHORTCUT_WORDS_REG
                OQ_QUEUE_2_DRAM_WR_WORDS_REG
                OQ_QUEUE_2_DRAM_RD_WORDS_REG
                OQ_QUEUE_2_CTRL_REG
                OQ_QUEUE_2_ADDR_LO_REG
                OQ_QUEUE_2_ADDR_HI_REG
                OQ_QUEUE_2_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_3_INPUT_WORDS_REG
                OQ_QUEUE_3_OUTPUT_WORDS_REG
                OQ_QUEUE_3_SHORTCUT_WORDS_REG
                OQ_QUEUE_3_DRAM_WR_WORDS_REG
                OQ_QUEUE_3_DRAM_RD_WORDS_REG
                OQ_QUEUE_3_CTRL_REG
                OQ_QUEUE_3_ADDR_LO_REG
                OQ_QUEUE_3_ADDR_HI_REG
                OQ_QUEUE_3_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_4_INPUT_WORDS_REG
                OQ_QUEUE_4_OUTPUT_WORDS_REG
                OQ_QUEUE_4_SHORTCUT_WORDS_REG
                OQ_QUEUE_4_DRAM_WR_WORDS_REG
                OQ_QUEUE_4_DRAM_RD_WORDS_REG
                OQ_QUEUE_4_CTRL_REG
                OQ_QUEUE_4_ADDR_LO_REG
                OQ_QUEUE_4_ADDR_HI_REG
                OQ_QUEUE_4_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_5_INPUT_WORDS_REG
                OQ_QUEUE_5_OUTPUT_WORDS_REG
                OQ_QUEUE_5_SHORTCUT_WORDS_REG
                OQ_QUEUE_5_DRAM_WR_WORDS_REG
                OQ_QUEUE_5_DRAM_RD_WORDS_REG
                OQ_QUEUE_5_CTRL_REG
                OQ_QUEUE_5_ADDR_LO_REG
                OQ_QUEUE_5_ADDR_HI_REG
                OQ_QUEUE_5_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_6_INPUT_WORDS_REG
                OQ_QUEUE_6_OUTPUT_WORDS_REG
                OQ_QUEUE_6_SHORTCUT_WORDS_REG
                OQ_QUEUE_6_DRAM_WR_WORDS_REG
                OQ_QUEUE_6_DRAM_RD_WORDS_REG
                OQ_QUEUE_6_CTRL_REG
                OQ_QUEUE_6_ADDR_LO_REG
                OQ_QUEUE_6_ADDR_HI_REG
                OQ_QUEUE_6_SHORTCUT_DISABLE_REG
                ...
                OQ_QUEUE_7_INPUT_WORDS_REG
                OQ_QUEUE_7_OUTPUT_WORDS_REG
                OQ_QUEUE_7_SHORTCUT_WORDS_REG
                OQ_QUEUE_7_DRAM_WR_WORDS_REG
                OQ_QUEUE_7_DRAM_RD_WORDS_REG
                OQ_QUEUE_7_CTRL_REG
                OQ_QUEUE_7_ADDR_LO_REG
                OQ_QUEUE_7_ADDR_HI_REG
                OQ_QUEUE_7_SHORTCUT_DISABLE_REG
                ...
                BRAM_REG_ACCESS__REG
                OQ_CONTROL_DISABLE_SEND_POS 
                OQ_CONTROL_INITIALIZE_OQ_POS
                OQ_CONTROL_DISABLE_SEND     
...
sub DEVICE_PROJ_DIR ()  { "mpls_switch"; }
sub DEVICE_PROJ_NAME () { "MPLS dram switch"; }
sub DEVICE_PROJ_DESC () { "MPLS switch"; }
...
# ===== File: projects/mpls_switch/include/dram_rr_output_queues.xml =====

sub NUM_OUTPUT_QUEUES ()                  { 8;}

sub DRAM_DATA_WIDTH ()                    { 72;}

sub DRAM_BLOCK_RDWR_ADDR_WIDTH ()         { 15;}

sub OQ_DEFAULT_MAX_PKTS ()                 { 0xffffff;}

sub OQ_DRAM_PKT_CNT_WIDTH ()              { 24;}

sub OQ_DRAM_WORD_CNT_WIDTH ()             { 24;}

sub OQ_DRAM_BYTE_CNT_WIDTH ()             { 24;}

sub OQ_DISABLE_SEND_BIT_NUM ()            { 0;}
...
sub STRIP_HEADERS_BASE_ADDR ()     { 0x2000000; }
sub SWITCH_OP_LUT_BASE_ADDR ()     { 0x2000100; }
sub IN_ARB_BASE_ADDR ()            { 0x2000200; }
sub OQ_BASE_ADDR ()                { 0x2001000; }
sub BRAM_REG_ACCESS_BASE_ADDR ()   { 0x2002000; }
...
# File: lib/verilog/core/output_port_lookup/mpls_lookup/xml/learning_cam_switch.xml
sub SWITCH_OP_LUT_MAC0_HI_REG ()         { 0x2000100;}
sub SWITCH_OP_LUT_MAC0_LO_REG ()         { 0x2000104;}
sub SWITCH_OP_LUT_MAC1_HI_REG ()         { 0x2000108;}
sub SWITCH_OP_LUT_MAC1_LO_REG ()         { 0x200010c;}
sub SWITCH_OP_LUT_MAC2_HI_REG ()         { 0x2000110;}
sub SWITCH_OP_LUT_MAC2_LO_REG ()         { 0x2000114;}
sub SWITCH_OP_LUT_MAC3_HI_REG ()         { 0x2000118;}
sub SWITCH_OP_LUT_MAC3_LO_REG ()         { 0x200011c;}
sub SWITCH_OP_LUT_LS1_BASE_REG ()        { 0x2000120;}
sub SWITCH_OP_LUT_LS1_BOUND_REG ()       { 0x2000124;}
sub SWITCH_OP_LUT_LS2_BASE_REG ()        { 0x2000128;}
sub SWITCH_OP_LUT_LS2_BOUND_REG ()       { 0x200012c;}
sub SWITCH_OP_LUT_LS3_BASE_REG ()        { 0x2000130;}
sub SWITCH_OP_LUT_LS3_BOUND_REG ()       { 0x2000134;}
sub SWITCH_OP_LUT_LS4_BASE_REG ()        { 0x2000138;}
sub SWITCH_OP_LUT_LS4_BOUND_REG ()       { 0x200013c;}
sub SWITCH_OP_LUT_LD_BASE_REG ()         { 0x2000140;}
sub SWITCH_OP_LUT_LD_BOUND_REG ()        { 0x2000144;}
sub SWITCH_OP_LUT_COUNTER1_BASE_REG ()   { 0x2000148;}
sub SWITCH_OP_LUT_COUNTER2_BASE_REG ()   { 0x200014c;}
sub SWITCH_OP_LUT_SOFT_OFFSET_REG ()     { 0x2000150;}
sub SWITCH_OP_LUT_NOT_FOR_US_REG ()      { 0x2000154;}
sub SWITCH_OP_LUT_PARITY_ERROR_REG ()    { 0x2000158;}
sub SWITCH_OP_LUT_TTL_ERROR_REG ()       { 0x200015c;}
sub SWITCH_OP_LUT_LS_ERROR_REG ()        { 0x2000160;}
sub SWITCH_OP_LUT_LD_ERROR_REG ()        { 0x2000164;}
...
# Description: DRAM-based output queue using round-robin removal
# File: projects/mpls_switch/include/dram_rr_output_queues.xml
sub OQ_QUEUE_0_NUM_PKTS_STORED_REG ()    { 0x2001000;}
sub OQ_QUEUE_0_NUM_PKTS_DROPPED_REG ()   { 0x2001004;}
sub OQ_QUEUE_0_NUM_PKTS_REMOVED_REG ()   { 0x2001008;}
sub OQ_QUEUE_0_INPUT_WORDS_REG ()        { 0x200100c;}
sub OQ_QUEUE_0_OUTPUT_WORDS_REG ()       { 0x2001010;}
sub OQ_QUEUE_0_SHORTCUT_WORDS_REG ()     { 0x2001014;}
sub OQ_QUEUE_0_DRAM_WR_WORDS_REG ()      { 0x2001018;}
sub OQ_QUEUE_0_DRAM_RD_WORDS_REG ()      { 0x200101c;}
sub OQ_QUEUE_0_CTRL_REG ()               { 0x2001020;}
sub OQ_QUEUE_0_ADDR_LO_REG ()            { 0x2001024;}
sub OQ_QUEUE_0_ADDR_HI_REG ()            { 0x2001028;}
sub OQ_QUEUE_0_SHORTCUT_DISABLE_REG ()   { 0x200102c;}
sub OQ_QUEUE_0_WR_ADDR_REG ()            { 0x2001030;}
sub OQ_QUEUE_0_RD_ADDR_REG ()            { 0x2001034;}
sub OQ_QUEUE_0_NUM_PKTS_IN_Q_REG ()      { 0x2001038;}
sub OQ_QUEUE_1_NUM_PKTS_STORED_REG ()    { 0x2001200;}
sub OQ_QUEUE_1_NUM_PKTS_DROPPED_REG ()   { 0x2001204;}
sub OQ_QUEUE_1_NUM_PKTS_REMOVED_REG ()   { 0x2001208;}
sub OQ_QUEUE_1_INPUT_WORDS_REG ()        { 0x200120c;}
sub OQ_QUEUE_1_OUTPUT_WORDS_REG ()       { 0x2001210;}
sub OQ_QUEUE_1_SHORTCUT_WORDS_REG ()     { 0x2001214;}
sub OQ_QUEUE_1_DRAM_WR_WORDS_REG ()      { 0x2001218;}
sub OQ_QUEUE_1_DRAM_RD_WORDS_REG ()      { 0x200121c;}
sub OQ_QUEUE_1_CTRL_REG ()               { 0x2001220;}
sub OQ_QUEUE_1_ADDR_LO_REG ()            { 0x2001224;}
sub OQ_QUEUE_1_ADDR_HI_REG ()            { 0x2001228;}
sub OQ_QUEUE_1_SHORTCUT_DISABLE_REG ()   { 0x200122c;}
sub OQ_QUEUE_1_WR_ADDR_REG ()            { 0x2001230;}
sub OQ_QUEUE_1_RD_ADDR_REG ()            { 0x2001234;}
sub OQ_QUEUE_1_NUM_PKTS_IN_Q_REG ()      { 0x2001238;}
sub OQ_QUEUE_2_NUM_PKTS_STORED_REG ()    { 0x2001400;}
sub OQ_QUEUE_2_NUM_PKTS_DROPPED_REG ()   { 0x2001404;}
sub OQ_QUEUE_2_NUM_PKTS_REMOVED_REG ()   { 0x2001408;}
sub OQ_QUEUE_2_INPUT_WORDS_REG ()        { 0x200140c;}
sub OQ_QUEUE_2_OUTPUT_WORDS_REG ()       { 0x2001410;}
sub OQ_QUEUE_2_SHORTCUT_WORDS_REG ()     { 0x2001414;}
sub OQ_QUEUE_2_DRAM_WR_WORDS_REG ()      { 0x2001418;}
sub OQ_QUEUE_2_DRAM_RD_WORDS_REG ()      { 0x200141c;}
sub OQ_QUEUE_2_CTRL_REG ()               { 0x2001420;}
sub OQ_QUEUE_2_ADDR_LO_REG ()            { 0x2001424;}
sub OQ_QUEUE_2_ADDR_HI_REG ()            { 0x2001428;}
sub OQ_QUEUE_2_SHORTCUT_DISABLE_REG ()   { 0x200142c;}
sub OQ_QUEUE_2_WR_ADDR_REG ()            { 0x2001430;}
sub OQ_QUEUE_2_RD_ADDR_REG ()            { 0x2001434;}
sub OQ_QUEUE_2_NUM_PKTS_IN_Q_REG ()      { 0x2001438;}
sub OQ_QUEUE_3_NUM_PKTS_STORED_REG ()    { 0x2001600;}
sub OQ_QUEUE_3_NUM_PKTS_DROPPED_REG ()   { 0x2001604;}
sub OQ_QUEUE_3_NUM_PKTS_REMOVED_REG ()   { 0x2001608;}
sub OQ_QUEUE_3_INPUT_WORDS_REG ()        { 0x200160c;}
sub OQ_QUEUE_3_OUTPUT_WORDS_REG ()       { 0x2001610;}
sub OQ_QUEUE_3_SHORTCUT_WORDS_REG ()     { 0x2001614;}
sub OQ_QUEUE_3_DRAM_WR_WORDS_REG ()      { 0x2001618;}
sub OQ_QUEUE_3_DRAM_RD_WORDS_REG ()      { 0x200161c;}
sub OQ_QUEUE_3_CTRL_REG ()               { 0x2001620;}
sub OQ_QUEUE_3_ADDR_LO_REG ()            { 0x2001624;}
sub OQ_QUEUE_3_ADDR_HI_REG ()            { 0x2001628;}
sub OQ_QUEUE_3_SHORTCUT_DISABLE_REG ()   { 0x200162c;}
sub OQ_QUEUE_3_WR_ADDR_REG ()            { 0x2001630;}
sub OQ_QUEUE_3_RD_ADDR_REG ()            { 0x2001634;}
sub OQ_QUEUE_3_NUM_PKTS_IN_Q_REG ()      { 0x2001638;}
sub OQ_QUEUE_4_NUM_PKTS_STORED_REG ()    { 0x2001800;}
sub OQ_QUEUE_4_NUM_PKTS_DROPPED_REG ()   { 0x2001804;}
sub OQ_QUEUE_4_NUM_PKTS_REMOVED_REG ()   { 0x2001808;}
sub OQ_QUEUE_4_INPUT_WORDS_REG ()        { 0x200180c;}
sub OQ_QUEUE_4_OUTPUT_WORDS_REG ()       { 0x2001810;}
sub OQ_QUEUE_4_SHORTCUT_WORDS_REG ()     { 0x2001814;}
sub OQ_QUEUE_4_DRAM_WR_WORDS_REG ()      { 0x2001818;}
sub OQ_QUEUE_4_DRAM_RD_WORDS_REG ()      { 0x200181c;}
sub OQ_QUEUE_4_CTRL_REG ()               { 0x2001820;}
sub OQ_QUEUE_4_ADDR_LO_REG ()            { 0x2001824;}
sub OQ_QUEUE_4_ADDR_HI_REG ()            { 0x2001828;}
sub OQ_QUEUE_4_SHORTCUT_DISABLE_REG ()   { 0x200182c;}
sub OQ_QUEUE_4_WR_ADDR_REG ()            { 0x2001830;}
sub OQ_QUEUE_4_RD_ADDR_REG ()            { 0x2001834;}
sub OQ_QUEUE_4_NUM_PKTS_IN_Q_REG ()      { 0x2001838;}
sub OQ_QUEUE_5_NUM_PKTS_STORED_REG ()    { 0x2001a00;}
sub OQ_QUEUE_5_NUM_PKTS_DROPPED_REG ()   { 0x2001a04;}
sub OQ_QUEUE_5_NUM_PKTS_REMOVED_REG ()   { 0x2001a08;}
sub OQ_QUEUE_5_INPUT_WORDS_REG ()        { 0x2001a0c;}
sub OQ_QUEUE_5_OUTPUT_WORDS_REG ()       { 0x2001a10;}
sub OQ_QUEUE_5_SHORTCUT_WORDS_REG ()     { 0x2001a14;}
sub OQ_QUEUE_5_DRAM_WR_WORDS_REG ()      { 0x2001a18;}
sub OQ_QUEUE_5_DRAM_RD_WORDS_REG ()      { 0x2001a1c;}
sub OQ_QUEUE_5_CTRL_REG ()               { 0x2001a20;}
sub OQ_QUEUE_5_ADDR_LO_REG ()            { 0x2001a24;}
sub OQ_QUEUE_5_ADDR_HI_REG ()            { 0x2001a28;}
sub OQ_QUEUE_5_SHORTCUT_DISABLE_REG ()   { 0x2001a2c;}
sub OQ_QUEUE_5_WR_ADDR_REG ()            { 0x2001a30;}
sub OQ_QUEUE_5_RD_ADDR_REG ()            { 0x2001a34;}
sub OQ_QUEUE_5_NUM_PKTS_IN_Q_REG ()      { 0x2001a38;}
sub OQ_QUEUE_6_NUM_PKTS_STORED_REG ()    { 0x2001c00;}
sub OQ_QUEUE_6_NUM_PKTS_DROPPED_REG ()   { 0x2001c04;}
sub OQ_QUEUE_6_NUM_PKTS_REMOVED_REG ()   { 0x2001c08;}
sub OQ_QUEUE_6_INPUT_WORDS_REG ()        { 0x2001c0c;}
sub OQ_QUEUE_6_OUTPUT_WORDS_REG ()       { 0x2001c10;}
sub OQ_QUEUE_6_SHORTCUT_WORDS_REG ()     { 0x2001c14;}
sub OQ_QUEUE_6_DRAM_WR_WORDS_REG ()      { 0x2001c18;}
sub OQ_QUEUE_6_DRAM_RD_WORDS_REG ()      { 0x2001c1c;}
sub OQ_QUEUE_6_CTRL_REG ()               { 0x2001c20;}
sub OQ_QUEUE_6_ADDR_LO_REG ()            { 0x2001c24;}
sub OQ_QUEUE_6_ADDR_HI_REG ()            { 0x2001c28;}
sub OQ_QUEUE_6_SHORTCUT_DISABLE_REG ()   { 0x2001c2c;}
sub OQ_QUEUE_6_WR_ADDR_REG ()            { 0x2001c30;}
sub OQ_QUEUE_6_RD_ADDR_REG ()            { 0x2001c34;}
sub OQ_QUEUE_6_NUM_PKTS_IN_Q_REG ()      { 0x2001c38;}
sub OQ_QUEUE_7_NUM_PKTS_STORED_REG ()    { 0x2001e00;}
sub OQ_QUEUE_7_NUM_PKTS_DROPPED_REG ()   { 0x2001e04;}
sub OQ_QUEUE_7_NUM_PKTS_REMOVED_REG ()   { 0x2001e08;}
sub OQ_QUEUE_7_INPUT_WORDS_REG ()        { 0x2001e0c;}
sub OQ_QUEUE_7_OUTPUT_WORDS_REG ()       { 0x2001e10;}
sub OQ_QUEUE_7_SHORTCUT_WORDS_REG ()     { 0x2001e14;}
sub OQ_QUEUE_7_DRAM_WR_WORDS_REG ()      { 0x2001e18;}
sub OQ_QUEUE_7_DRAM_RD_WORDS_REG ()      { 0x2001e1c;}
sub OQ_QUEUE_7_CTRL_REG ()               { 0x2001e20;}
sub OQ_QUEUE_7_ADDR_LO_REG ()            { 0x2001e24;}
sub OQ_QUEUE_7_ADDR_HI_REG ()            { 0x2001e28;}
sub OQ_QUEUE_7_SHORTCUT_DISABLE_REG ()   { 0x2001e2c;}
sub OQ_QUEUE_7_WR_ADDR_REG ()            { 0x2001e30;}
sub OQ_QUEUE_7_RD_ADDR_REG ()            { 0x2001e34;}
sub OQ_QUEUE_7_NUM_PKTS_IN_Q_REG ()      { 0x2001e38;}

sub OQ_QUEUE_GROUP_BASE_ADDR ()  { 0x2001000; }
sub OQ_QUEUE_GROUP_INST_OFFSET() { 0x0000200; }

# Name: bram_access (BRAM_REG_ACCESS)
# Description: bram lookup for MPLS switch
# File: lib/verilog/core/bram_arbiter/xml/bram_access.xml
sub BRAM_REG_ACCESS__REG ()   { 0x2002000;}
...
sub OQ_CONTROL_DISABLE_SEND_POS  ()   { 0; }
sub OQ_CONTROL_INITIALIZE_OQ_POS ()   { 1; }

# Part 2: masks/values
sub OQ_CONTROL_DISABLE_SEND      ()   { 0x1; }
