...
# Write address of LS2 base register here for reading the content 
   my $addr34 = 0x2000128;

# Write address of LS2 bound register here for reading the content 
   my $addr35 = 0x200012c;

# Write address of LS3 base register here for reading the content 
   my $addr36 = 0x2000130;

# Write address of LS3 bound register here for reading the content 
   my $addr37 = 0x2000134;

# Write address of LS4 base register here for reading the content 
   my $addr38 = 0x2000138;

# Write address of LS4 bound register here for reading the content 
   my $addr39 = 0x200013c;

# Write address of LD base register here for reading the content 
   my $addr40 = 0x2000140;

# Write address of LD bound register here for reading the content 
   my $addr41 = 0x2000144;
...
sleep (0.1);
  my $val34= nf_regread($iface, $addr34);
sleep (0.1);
  my $val35= nf_regread($iface, $addr35);
sleep (0.1);
  my $val36= nf_regread($iface, $addr36);
sleep (0.1);
  my $val37= nf_regread($iface, $addr37);

sleep (0.1);
  my $val38= nf_regread($iface, $addr38);
sleep (0.1);
  my $val39= nf_regread($iface, $addr39);
sleep (0.1);
  my $val40= nf_regread($iface, $addr40);
sleep (0.1);
  my $val41= nf_regread($iface, $addr41);
...
sleep (0.1);
  printf("LS2 base register 0x%08x (%u):   0x%08x (%u)\n", $addr34, $addr34, $val34, $val34);
sleep (0.1);
 printf("LS2 bound register 0x%08x (%u):   0x%08x (%u)\n", $addr35, $addr35, $val35, $val35);

sleep (0.1);
  printf("LS3 base register 0x%08x (%u):   0x%08x (%u)\n", $addr36, $addr36, $val36, $val36);
sleep (0.1);
 printf("LS3 bound register 0x%08x (%u):   0x%08x (%u)\n", $addr37, $addr37, $val37, $val37);

sleep (0.1);
  printf("LS4 base register 0x%08x (%u):   0x%08x (%u)\n", $addr38, $addr38, $val38, $val38);
sleep (0.1);
 printf("LS4 bound register 0x%08x (%u):   0x%08x (%u)\n", $addr39, $addr39, $val39, $val39);

sleep (0.1);
  printf("LD base register 0x%08x (%u):   0x%08x (%u)\n", $addr40, $addr40, $val40, $val40);
sleep (0.1);
 printf("LD bound register 0x%08x (%u):   0x%08x (%u)\n", $addr41, $addr41, $val41, $val41);
