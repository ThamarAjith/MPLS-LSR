...
# Write address and content of SRAM_REG register here 
   my $addr12 = 0x100000c;
   my $val12 = 0xc88880c5; # Parity Check = c5; Dist. Offset = 0x88880 >> 2 = 22220

# Write address and content of SRAM_REG register here 
   my $addr13 = 0x1000008;
   my $val13 = 0x080c0000; # Next_Label=N/A because of Load Distribution; Dest_MAC=3 (4th BRAM entry);port=2;

# Write address and content of SRAM_REG register here 
   my $addr14 = 0x1000004;
   my $val14 = 0x00000054; # Cmd=5 (Pop+Swap); Load Distribution=4

# Write address and content of SRAM_REG register here 
   my $addr15 = 0x1000000;
   my $val15 = 0xffffffff; # Commit
...
# Write address and content of SRAM_REG register here 
   my $addr24 = 0x122220c; 
   my $val24 = 0xc0003040; # LD1 value, Parity=40, Swap_Label = 0000c >> 2 = 3

# Write address and content of SRAM_REG register here 
   my $addr25 = 0x1222208;
   my $val25 = 0x080c0000; # Zeros in Swap Lable (above), Dest MAC=0c >> 2 = 3, Dest Port = 8 >> 2 = 2
