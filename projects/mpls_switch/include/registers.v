...
`define OQ_DEFAULT_MAX_PKTS                 24'hffffff
...
// Tag/address widths
`define BRAM_REG_ACCESS_BLOCK_ADDR_WIDTH  13
`define BRAM_REG_ACCESS_REG_ADDR_WIDTH    10
...
`define BRAM_REG_ACCESS_BLOCK_ADDR  13'h0002
...
`define SWITCH_OP_LUT_MAC0_HI        6'h0
`define SWITCH_OP_LUT_MAC0_LO        6'h1
`define SWITCH_OP_LUT_MAC1_HI        6'h2
`define SWITCH_OP_LUT_MAC1_LO        6'h3
`define SWITCH_OP_LUT_MAC2_HI        6'h4
`define SWITCH_OP_LUT_MAC2_LO        6'h5
`define SWITCH_OP_LUT_MAC3_HI        6'h6
`define SWITCH_OP_LUT_MAC3_LO        6'h7
`define SWITCH_OP_LUT_LS1_BASE       6'h8
`define SWITCH_OP_LUT_LS1_BOUND      6'h9
`define SWITCH_OP_LUT_LS2_BASE       6'ha
`define SWITCH_OP_LUT_LS2_BOUND      6'hb
`define SWITCH_OP_LUT_LS3_BASE       6'hc
`define SWITCH_OP_LUT_LS3_BOUND      6'hd
`define SWITCH_OP_LUT_LS4_BASE       6'he
`define SWITCH_OP_LUT_LS4_BOUND      6'hf
`define SWITCH_OP_LUT_LD_BASE        6'h10
`define SWITCH_OP_LUT_LD_BOUND       6'h11
`define SWITCH_OP_LUT_COUNTER1_BASE  6'h12
`define SWITCH_OP_LUT_COUNTER2_BASE  6'h13
`define SWITCH_OP_LUT_SOFT_OFFSET    6'h14
`define SWITCH_OP_LUT_NOT_FOR_US     6'h15
`define SWITCH_OP_LUT_PARITY_ERROR   6'h16
`define SWITCH_OP_LUT_TTL_ERROR      6'h17
`define SWITCH_OP_LUT_LS_ERROR       6'h18
`define SWITCH_OP_LUT_LD_ERROR       6'h19
...
`define OQ_QUEUE_NUM_PKTS_STORED   7'h0
`define OQ_QUEUE_NUM_PKTS_DROPPED  7'h1
`define OQ_QUEUE_NUM_PKTS_REMOVED  7'h2
`define OQ_QUEUE_INPUT_WORDS       7'h3
`define OQ_QUEUE_OUTPUT_WORDS      7'h4
`define OQ_QUEUE_SHORTCUT_WORDS    7'h5
`define OQ_QUEUE_DRAM_WR_WORDS     7'h6
`define OQ_QUEUE_DRAM_RD_WORDS     7'h7
`define OQ_QUEUE_CTRL              7'h8
`define OQ_QUEUE_ADDR_LO           7'h9
`define OQ_QUEUE_ADDR_HI           7'ha
`define OQ_QUEUE_SHORTCUT_DISABLE  7'hb
`define OQ_QUEUE_WR_ADDR           7'hc
`define OQ_QUEUE_RD_ADDR           7'hd
`define OQ_QUEUE_NUM_PKTS_IN_Q     7'he
